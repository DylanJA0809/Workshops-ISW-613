...
<head>
    ...
    <title>Editar Carreras - Workshop</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navMain">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="<?php echo site_url('edit_careers'); ?>">Editar Carrera</a>
                </li>
                <li class="nav-item">
...
<main class="container my-5">
    <h1 class="mb-4">Editar Carreras</h1>
                    ...
                    <tbody>
                        <?php foreach ($carreras as $carrera) : ?>
                            <tr>
                                ...
                                <td>
                                    <form class="d-flex" action="<?php echo site_url('update_career/' . $carrera['id']); ?>" method="post">
                                        <input type="text"
                                               name="nombre"
                                               class="form-control form-control-sm me-2"
                                               value="<?= esc($carrera['nombre']); ?>"
                                               required>
                                </td>
                                <td>
                                        ...
                                        <a href="<?php echo site_url('delete_career/' . $carrera['id']); ?>"
                                           class="btn btn-sm btn-danger"
                                           onclick="return confirm('¿Seguro que desea eliminar esta carrera?');">
                                            Eliminar
                                        </a>
                                    </form>
                                </td>
